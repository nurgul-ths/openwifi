...
Running individual commands with subprocess in python creates a new shell for each command.
This is very inefficient. Instead, we use paramiko to create a single ssh connection and
run multiple commands on the same shell.
"""
